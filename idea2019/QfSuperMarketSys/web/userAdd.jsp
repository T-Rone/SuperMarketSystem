    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="<%=request.getContextPath() %>/addUserServlet" method="post">
                ...
                <div>
                    <label for="userRemi">年龄：</label>
                    <input type="text" name="age" id="userRemi"/>
                    <span>*年龄必须是数字</span>
                </div>
                <div>
                    <label >用户性别：</label>
                ...
                <div>
                    ...
                    <input type="radio" name="userRole" value="经理"/>经理
                    <input type="radio" name="userRole" value="普通用户"/>普通用户
