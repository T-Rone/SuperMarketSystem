    ...
    <div class="left">
        ...
        <nav>
            <ul class="list">
                ...
                <li id="active"><a href="updateUserPassword">密码修改</a></li>
        ...
        <div class="providerAdd">
            <form action="#">
                ...
                <div class="">
                    ...
                    <input type="password" name="oldPassword" id="oldPassword" value="${sessionScope.user.userPassword}" required/>
                    <span>*请输入原密码</span>
                </div>
                <div>
                ...
                <div class="providerAddBtn">
                    <!--<a href="#">保存</a>-->
                    <input type="button" value="修改" onclick="updatePassword()"/>
...
<script type="text/javascript">
    function updatePassword() {
        ...
        if (renewPassword!==newPassword)
        {
            ...
            if(confirm("确定要修改么？"))
            {
                location.href="updateUserPassword?name=${sessionScope.user.userName}&password="+newPassword;
            }
    }
</script>
</body>
